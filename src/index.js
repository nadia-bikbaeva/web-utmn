...
const game = {
  ...
  // Проверяем, не врезается ли змейка в саму себя.
  const isCollisionWithBody = this.snake.isOnPoint(nextHeadPoint);

  return !isCollisionWithBody;
  },
};
